...
try {
    ...
    $queryProducts = "SELECT * FROM products WHERE status = 1";
...
<span
    class="text-danger fw-bold text-decoration-underline"><b><?php echo "Total Invertido en Productos: $" . number_format($totalProductos, 2) ?></b></span>
<br>
<span><b><?php echo "Total de cantidad de Productos: " . $totalCantidad ?></b></span>
<br>
<span><b><?php echo "Total de productos con cantidad registrada: " . $count ?></b></span>
<script>
